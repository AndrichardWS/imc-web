...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 09 Jul 2021 pada 18.10
...
(3, 1, 'ECO TALKS', 'Lorem ipsum dolor sit amet consectetur adipisicing elit. Consectetur harum officia ipsam quasi autem id quisquam laboriosam reiciendis earum facere excepturi atque quam eius aperiam voluptate incidunt, sit, blanditiis nostrum?', 'feed.jpg'),
...
(2, 2, 'user', '$2y$10$JRQHPac0c6/yss6gTwltJ.FuR7HV49X50tdJioutxj8l5QLJo5TR.', 'User', 'Aktif');
...
(2, 2, 1, 'Belajar Pemrograman Pemula', 'Lorem ipsum dolor sit amet consectetur adipisicing elit. Quasi, ullam veniam delectus praesentium, eius unde error fuga impedit sequi maxime voluptatibus aliquid quos dolores alias at et provident odit esse.', 'program.jpg'),
...
--
ALTER TABLE `community`
  MODIFY `id_community` int(2) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `pengguna`
  MODIFY `id_pengguna` int(2) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `region`
  MODIFY `id_region` int(2) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
